    ...
    for batch_num in 0..=(titles.len() / batch_size) {
        ...
        let request = AnnotationRequest {
            ...
            system: "ニコニコ動画のボカロオリジナル曲タイトルから、曲の実際の名前（曲名）を抽出してください。\n\n\
                     ## 歴史的背景（参考）\n\n\
                     ニコニコ動画ボカロ曲タイトルには歴史的に2大流派がある：\n\
                     - **【】流派**（〜2014年頃）：【ボカロ名】曲名【オリジナル曲】\n\
                     - **/ 流派**（2014年以降）：曲名 / ボカロ名\n\
                     - **クリエイター名先頭パターン**（増加傾向）：クリエイター - 曲名 feat. ボカロ など\n\n\
                     ## 除去すべき要素\n\n\
                     **ボーカロイド・アーティスト名**（以下のパターンの後に付く）\n\
                     ...
                     **その他の区切り文字**\n\
                     - 曲名 - クリエイター（ハイフン区切り）\n\
                     - 曲名 feat. ボカロ、曲名 feat. ボカロ（feat. パターン）\n\
                     - 曲名 ft. ボカロ（ft. パターン）\n\
                     - 曲名 Vo. ボカロ、曲名 vo. ボカロ（ボーカル指示）\n\
                     - 曲名_ボカロ（アンダースコア分割）\n\
                     - 曲名　ボカロ（全角スペース区切り）\n\n\
                     **クリエイター名先頭パターン（「」や『』内に曲名）**\n\
                     - utage「mirroring」- 初音ミク → 曲名は「」内\n\
                     - 稲葉曇『ラグトレイン』Vo. 歌愛ユキ → 曲名は『』内\n\
                     - Chinozo「グッバイ宣言」feat. flower → 曲名は「」内\n\n\
                     **メタデータ（括弧を含めて除去）**\n\
                     - 【MV】【オリジナル曲】【ボカロオリジナル曲】など（日本語角括弧）\n\
                     - [MV][Official]などの英語角括弧\n\
                     - （PV）（short ver）などの日本語丸括弧\n\
